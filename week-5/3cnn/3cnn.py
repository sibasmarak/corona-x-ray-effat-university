...
print_confusion_matrix_and_save(y_train, np.argmax(y_pred_train, axis=1), name='-3CNN-train', fp=fp)
...
print_confusion_matrix_and_save(y_dev, np.argmax(y_pred_dev, axis=1), name='-3CNN-dev', fp=fp)
...
print_confusion_matrix_and_save(y_test, np.argmax(y_pred_test, axis=1),name='-3CNN-test', fp=fp)
